...
const routerConfig = ({ history, app }) => {
  const UserLayout = dynamic({ app, models: () => [import('./models/layout/userLayout')], component: () => import('./components/layout/UserLayout') })
  const Menu = dynamic({ app, models: () => [import('./models/sys/menu')], component: () => import('./routes/sys/Menu') })
